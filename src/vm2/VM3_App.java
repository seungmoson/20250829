...
// ======================================================
// VM3 루트/상속형 자판기 (패치 버전: 다운캐스팅 제거)
// - 공통 로직: VM3_VendingMachine (추상 클래스)
// - 인터페이스: VM3_IProduct (제품 스펙 + 가격 setter 추가)
// - 구체 자판기: VM3_BeverageMachine, VM3_RamenMachine, VM3_CigaretteMachine
// - 실행 진입점: VM3_App.main()
// ======================================================
public class VM3_App {
    ...
    interface VM3_IProduct {
        ...
        void   VM3_setPrice(int VM3_price); // ★ 추가
    }
    ...
    static class VM3_Product implements VM3_IProduct {
        ...
        @Override public void   VM3_setPrice(int VM3_price)  { this.VM3_price = VM3_price; }
    }
    ...
    static abstract class VM3_VendingMachine {
        ...
        protected boolean VM3_validatePurchase(VM3_IProduct VM3_p, Scanner VM3_sc) { return true; }
            ...
            while (true) {
                ...
                switch (VM3_sel) {
                    case "1": {
                        ...
                        VM3_products.get(VM3_idx1).VM3_setPrice(VM3_newPrice); // ★ 캐스팅 없이 가격 변경
    ...
    static class VM3_BeverageMachine extends VM3_VendingMachine {
        ...
        @Override protected void VM3_initSamples() {
            if (VM3_products.isEmpty()) {
    ...
    static class VM3_RamenMachine extends VM3_VendingMachine {
        ...
        @Override protected void VM3_afterDispense(VM3_IProduct VM3_p, Scanner VM3_sc) {
    ...
    static class VM3_CigaretteMachine extends VM3_VendingMachine {
        ...
        @Override protected boolean VM3_validatePurchase(VM3_IProduct VM3_p, Scanner VM3_sc) {
